const findUserByCpfEmail = async (searchedUser) => {
  try {
    const response = await fetch("http://localhost:3000/api/usuario/search", {
      method: "POST",
      headers: {
    ...
    alert("Erro Crítico ao localizar usuário. Contate o Administrador");
    return
  }
};
